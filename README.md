...
- **Macro F1:** 0.92 · **Faithfulness (RAGAS):** 0.797
- Targeting an IEEE INDICON submission
...
### 🏋️ FormFusion
Multi-phone 3D motion capture fitness coaching system built at the Qualcomm Snapdragon Multiverse Hackathon. **4th place out of 60 teams.** Led ML: camera calibration, DLT triangulation, One-Euro filtering, rep counting, and LLM-based coaching feedback.

- **Reprojection error:** 0.0767px · **Jitter reduction:** 41%
- LLM feedback via Gemini + Sarvam AI
...
### 🛡️ Sahayak PFMS
Real-time payment fraud detection system combining Isolation Forest and Deep Autoencoders on 40,000+ government transactions.

🏆 **Hack4Delhi National Finalist** — Top 28 of 1,200+ teams
